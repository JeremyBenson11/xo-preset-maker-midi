xo-preset-maker-midi is a very straightforward application for building XLN XO presets. Upload any number of MIDI files with the same mapping. Set the working XO preset file for the application to gather the 
